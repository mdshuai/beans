...
server = "irc.devel.redhat.com" # Server
channel = "#openshift_lunch" # Channel
botnick = "lunch-bot" # Your bots nick
alll = "bmeng chunchen deshuai zzhao wjiang"
...
while 1: # Be careful with these! it might send you to an infinite loop
  ...
  if ircmsg.find(".all") != -1:
    sendmsg(channel, alll)
